# add static analyzer
macro(nsdpcpp_enable_cppcheck WARNINGS_AS_ERRORS CPPCHECK_OPTIONS) # cmake-lint: disable=C0103
...
#include clang-tide for target
macro(myproject_enable_clang_tidy target WARNINGS_AS_ERRORS) # cmake-lint: disable=C0103
           ...
           ".*Clang")
            ...
            if(NOT ("${TARGET_PCH}" STREQUAL "TARGET_PCH-NOTFOUND"))
                message(SEND_ERROR "clang-tidy cannot be enabled with non-clang compiler
                         and PCH, clang-tidy fails to handle gcc's PCH file")
            endif()
        endif()
